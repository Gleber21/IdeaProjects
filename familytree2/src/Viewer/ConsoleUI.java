...
public class ConsoleUI implements View{
    ...
    public void start() {
        ...
        while (work) {
            ...
            else System.out.println("Повторите ввод команды.");
        }
    }
    ...
    private void hello() {
        System.out.println("Это программа для составления семейного древа.");
    }
    ...
    public void addNewSubjectToTree() {
        ...
        if (tryToInt(strYear)) {
            ...
            System.out.println("Введенное значение некорректно, используем значение по умолчанию.");
        }
    ...
    private ViewGender genderChecking() {
        ...
        if(viewGender == ViewGender.NULL) {
            System.out.println("Введите номер команды заново.");
        }
        return viewGender;
    }
